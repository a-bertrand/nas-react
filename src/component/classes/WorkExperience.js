...
export function generate_fake_data()
{
    ...
    array_exp.push(new WorkExperience('Java EE',4,cat_fram))
    ...
    array_exp.push(new WorkExperience('NodeJs',5,cat_fram))
    ...
    array_exp.push(new WorkExperience('jQuery, UI & Mobile',9,cat_fram))
    // ---------------------------------------
    ...
    array_exp.push(new WorkExperience('Linux : Debian & Ubuntu',7,cat_sofware))
    ...
    array_exp.push(new WorkExperience('Git',5,cat_sofware))
    array_exp.push(new WorkExperience('Word, Excel, PowerPoint',6,cat_sofware))
    array_exp.push(new WorkExperience('Photoshop, InDesign',4,cat_sofware))
    array_exp.push(new WorkExperience('Logic pro X',8,cat_sofware))
    array_exp.push(new WorkExperience('Unity 3D',4,cat_sofware))
