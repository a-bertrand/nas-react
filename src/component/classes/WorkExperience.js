...
{
    let list_cat    = ['<i class="fa fa-code"></i> Languages dev',  '<i class="fa fa-book"></i> Framework / Bibliothèques', '<i class="fa fa-industry"></i> Experiences Professionnelles', 'Experiences Professionnelles hors développement','<i class="fa fa-graduation-cap"></i>Formations']
    ...
    array_exp.push(new WorkCompany("Developpeur Informatique (Alternance)","Développement de sites internets en utilisant divers Frameworks & CMS. Application mobile hybride, embarquée, native et desktop ainsi qu'une extension pour navigateur.",new Date('2016-06'),new Date('2017-07'),"L2C2",cat_company_info))
    ...
    // ---------------------------------------
    // cat_formation 
    array_exp.push(new WorkCompany("BAC + 3 : Licence Professionnelle - Métier de l'informatique applique au web (MI-AW)","Analyse & programmation informatiqe",new Date('2013'),new Date('2014'),"IUT 2 de Grenoble",cat_formation))
    array_exp.push(new WorkCompany("BAC + 2 : DUT informatique","Analyse & programmation informatiqe",new Date('2013'),new Date('2014'),"IUT 2 de Grenoble",cat_formation))
    /* --------------------------------------- */
